...
class ProgramBarStress: public Program
{
  ...
  virtual void addOptions(boost::program_options::options_description& options)
  {
    options.add_options()
      ...
      ("cycles",
       po::value<int>(&mOptions.cycles)->default_value(100),
       "Cycles of SWT writes(/reads) to perform")
      ("print-freq",
       po::value<int>(&mOptions.printFrequency)->default_value(10),
  ...
  int stress(Swt *swt, int cycles, int printFrequency, bool errorCheck) 
  {
  ...
  virtual void run(const boost::program_options::variables_map& map) 
  {
    ...
    int cycles_run = stress(&swt, mOptions.cycles, mOptions.printFrequency, mOptions.errorCheck);
